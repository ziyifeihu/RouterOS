...
PEAR2_Net_Transmitter and PEAR2_Cache_SHM will be placed into a sub folder named "vendor". After that, you can use the autoloader generated by Composer in "vendor/autoload.php" to load classes from the package.

__Note: If you plan to contribute to this project, please use GitHub's "fork" feature instead of the clone command.__
