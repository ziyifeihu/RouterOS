...
PEAR2_Net_Transmitter and PEAR2_Cache_SHM will be placed into a subfolder named "vendor. After that, you can use the autoloader generated by Composer in "vendor/autoload.php" to load the package.
